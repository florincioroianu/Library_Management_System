...
public class Users {
    ...
    public void addUser(String _fname, String _lname, String _username, String _password, String _user_type) {
        ...
        try {
            ...
            if (ps.executeUpdate() != 0) {
                JOptionPane.showMessageDialog(null, "Utilizator adaugat", "add user", 1);
            } else {
                JOptionPane.showMessageDialog(null, "Utilizatorul nu a fost adaugat", "user error", 2);
            }
    ...
    public boolean checkUsernameExists(int _id, String _username) {
        ResultSet rs = func
                .getData("SELECT * FROM `users_table` WHERE `username` = '" + _username + "' and id <> " + _id);
    ...
    public void editUser(int _id, String _fname, String _lname, String _username, String _password, String _user_type) {
        ...
        try {
            ...
            if (ps.executeUpdate() != 0) {
                JOptionPane.showMessageDialog(null, "Utilizator editat", "edit user", 1);
            } else {
                JOptionPane.showMessageDialog(null, "Utilizator needitat", "edit user", 2);
            }
    ...
    public void removeUser(int _id) {
        ...
        try {
            ...
            if (ps.executeUpdate() != 0) {
                JOptionPane.showMessageDialog(null, "Utilizator sters", "remove", 1);
            } else {
    ...
    public Users tryLogin(String _username, String _password) {
        ...
        ResultSet rs = func.getData(
                "SELECT * FROM `users_table` where username = '" + _username + "' and password = '" + _password + "'");
