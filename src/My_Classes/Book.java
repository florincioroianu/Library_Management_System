...
public class Book {
                ...
                String _publisher,double _price,String _date_received,String _description,byte[] _cover)
    {
        ...
        try {
            ...
            {
                JOptionPane.showMessageDialog(null, "Cartea a fost adaugata","add Book",1);
            }
            else
            {
                JOptionPane.showMessageDialog(null, "Cartea nu a fost adaugata","add book",2);
            }
                ...
                String _publisher,double _price,String _date_received,String _description,byte[] _cover)
    {
        ...
        else 
        {
           ...
           ps = DB.getConnection().prepareStatement(updateQuery);
            ...
            if(ps.executeUpdate() != 0)
            {
                JOptionPane.showMessageDialog(null, "Cartea a fost editata","edit Book",1);
            }
            else
            {
                JOptionPane.showMessageDialog(null, "Cartea nu a fost editata","edit book",2);
            }
    ...
    public void removeBook(int _id )
    {
        ...
        try {
            ...
            if(ps.executeUpdate() != 0)
            {
                JOptionPane.showMessageDialog(null, "Cartea a fost stearsa","remove",1);
            }
            else
            {
                JOptionPane.showMessageDialog(null, "Cartea nu a fost stearsa","remove",2);
            }
    ...
    // function to populate an array with books
    ...
    public void setQuantity_Minus_One(int _book_id, int _quantity)
    {
        ...
        try {
            ...
            if(ps.executeUpdate() != 0)
            {
                JOptionPane.showMessageDialog(null, "Aceasta carte a fost pierduta! -> Cantitatea disponibila a fost redusa ","edit Book Quantity",1);
            }
            else
            {
                JOptionPane.showMessageDialog(null, "Cantitatea nu a fost editata","edit Book Quantity",2);
            }
